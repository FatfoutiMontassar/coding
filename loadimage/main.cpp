...
int main( )
{
       ...
       // LOAD image
       image = imread("/home/montaf/Downloads/unnamed.png", CV_LOAD_IMAGE_COLOR);   // Read the file "image.jpg".
       ...
       //SAVE image
       imwrite("result.png",image);// it will store the image in name "result.jpg"
